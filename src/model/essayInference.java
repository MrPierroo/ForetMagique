...
public class essayInference {
	...
	public static void main(String[] args) {
		...
		BF.addAll(initialiserBaseDeFait()); //remplir la base de fait en fonction de l'�tat de l'environnement		
	...
	public static ArrayList<Regle> remplirBaseDeRegle() {
		...
		//regles impliquant un d�placement en haut
		...
		//regles impliquant un d�placement en bas
		...
		//regles impliquant un d�placement � droite
		...
		//Regles impliquant un d�placement � gauche
